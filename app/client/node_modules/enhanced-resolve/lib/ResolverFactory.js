...
const AliasFieldPlugin = require("enhanced-resolve/lib/AliasFieldPlugin");
const AliasPlugin = require("enhanced-resolve/lib/AliasPlugin");
const AppendPlugin = require("enhanced-resolve/lib/AppendPlugin");
const ConditionalPlugin = require("enhanced-resolve/lib/ConditionalPlugin");
const DescriptionFilePlugin = require("enhanced-resolve/lib/DescriptionFilePlugin");
const DirectoryExistsPlugin = require("enhanced-resolve/lib/DirectoryExistsPlugin");
const ExportsFieldPlugin = require("enhanced-resolve/lib/ExportsFieldPlugin");
const ExtensionAliasPlugin = require("enhanced-resolve/lib/ExtensionAliasPlugin");
const FileExistsPlugin = require("enhanced-resolve/lib/FileExistsPlugin");
const ImportsFieldPlugin = require("enhanced-resolve/lib/ImportsFieldPlugin");
const JoinRequestPartPlugin = require("enhanced-resolve/lib/JoinRequestPartPlugin");
const JoinRequestPlugin = require("enhanced-resolve/lib/JoinRequestPlugin");
const MainFieldPlugin = require("enhanced-resolve/lib/MainFieldPlugin");
...
const NextPlugin = require("enhanced-resolve/lib/NextPlugin");
const ParsePlugin = require("enhanced-resolve/lib/ParsePlugin");
const PnpPlugin = require("enhanced-resolve/lib/PnpPlugin");
const Resolver = require("enhanced-resolve/lib/Resolver");
const RestrictionsPlugin = require("enhanced-resolve/lib/RestrictionsPlugin");
const ResultPlugin = require("enhanced-resolve/lib/ResultPlugin");
const RootsPlugin = require("enhanced-resolve/lib/RootsPlugin");
const SelfReferencePlugin = require("enhanced-resolve/lib/SelfReferencePlugin");
const SymlinkPlugin = require("enhanced-resolve/lib/SymlinkPlugin");
const SyncAsyncFileSystemDecorator = require("enhanced-resolve/lib/SyncAsyncFileSystemDecorator");
const TryNextPlugin = require("enhanced-resolve/lib/TryNextPlugin");
const UnsafeCachePlugin = require("enhanced-resolve/lib/UnsafeCachePlugin");
const UseFilePlugin = require("enhanced-resolve/lib/UseFilePlugin");
const { PathType, getType } = require("enhanced-resolve/lib/util/path");

/** @typedef {import("enhanced-resolve/lib/AliasPlugin").AliasOption} AliasOptionEntry */
/** @typedef {import("enhanced-resolve/lib/ExtensionAliasPlugin").ExtensionAliasOption} ExtensionAliasOption */
/** @typedef {import("enhanced-resolve/lib/PnpPlugin").PnpApiImpl} PnpApi */
/** @typedef {import("enhanced-resolve/lib/Resolver").EnsuredHooks} EnsuredHooks */
/** @typedef {import("enhanced-resolve/lib/Resolver").FileSystem} FileSystem */
/** @typedef {import("enhanced-resolve/lib/Resolver").KnownHooks} KnownHooks */
/** @typedef {import("enhanced-resolve/lib/Resolver").ResolveRequest} ResolveRequest */
/** @typedef {import("enhanced-resolve/lib/Resolver").SyncFileSystem} SyncFileSystem */
/** @typedef {import("enhanced-resolve/lib/UnsafeCachePlugin").Cache} Cache */
		...
		if (unsafeCache) {
			plugins.push(
				new UnsafeCachePlugin(
					source,
					cachePredicate,
					/** @type {import("enhanced-resolve/lib/UnsafeCachePlugin").Cache} */ (unsafeCache),
					cacheWithContext,
					`new-${source}`,
				),
			);
