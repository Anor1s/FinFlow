...
/** @typedef {import("enhanced-resolve/lib/Resolver").PathLike} PathLike */
/** @typedef {import("enhanced-resolve/lib/Resolver").PathOrFileDescriptor} PathOrFileDescriptor */
...
/**
 * @template T
 * @typedef {import("enhanced-resolve/lib/Resolver").FileSystemCallback<T>} FileSystemCallback<T>
 */
