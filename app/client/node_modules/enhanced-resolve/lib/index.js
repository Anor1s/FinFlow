...
const memoize = require("enhanced-resolve/lib/util/memoize");

/** @typedef {import("enhanced-resolve/lib/CachedInputFileSystem").BaseFileSystem} BaseFileSystem */
...
/** @typedef {import("enhanced-resolve/lib/Resolver").ResolveCallback} ResolveCallback */
/** @typedef {import("enhanced-resolve/lib/Resolver").ResolveContext} ResolveContext */
...
/** @typedef {import("enhanced-resolve/lib/ResolverFactory").Plugin} Plugin */
/** @typedef {import("enhanced-resolve/lib/ResolverFactory").UserResolveOptions} ResolveOptions */
...
const getCachedFileSystem = memoize(() => require("enhanced-resolve/lib/CachedInputFileSystem"));
...
const getResolverFactory = memoize(() => require("enhanced-resolve/lib/ResolverFactory"));
...
module.exports = mergeExports(resolve, {
	...
	get CloneBasenamePlugin() {
		return require("enhanced-resolve/lib/CloneBasenamePlugin");
	},
	get LogInfoPlugin() {
		return require("enhanced-resolve/lib/LogInfoPlugin");
	},
	get forEachBail() {
		return require("enhanced-resolve/lib/forEachBail");
	},
});
