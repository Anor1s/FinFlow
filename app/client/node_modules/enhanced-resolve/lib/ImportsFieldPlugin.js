...
const { processImportsField } = require("enhanced-resolve/lib/util/entrypoints");
const { parseIdentifier } = require("enhanced-resolve/lib/util/identifier");
const {
...
/** @typedef {import("enhanced-resolve/lib/Resolver").JsonObject} JsonObject */
/** @typedef {import("enhanced-resolve/lib/Resolver").ResolveRequest} ResolveRequest */
/** @typedef {import("enhanced-resolve/lib/Resolver").ResolveStepHook} ResolveStepHook */
/** @typedef {import("enhanced-resolve/lib/util/entrypoints").FieldProcessor} FieldProcessor */
/** @typedef {import("enhanced-resolve/lib/util/entrypoints").ImportsField} ImportsField */
