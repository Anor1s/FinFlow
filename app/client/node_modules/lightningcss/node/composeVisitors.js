...
/**
 * @param {import('lightningcss').Visitor['Rule']} f
 * @param {import('lightningcss/node/ast').Rule} item
 */
...
/**
 * @param {import('lightningcss').Visitor['Declaration']} f
 * @param {import('lightningcss/node/ast').Declaration} item
 */
 ...
 * @param {Visitor[]} visitors 
 * @param {string} key 
 * @param {import('lightningcss/node/ast').TokenOrValue['type']} type
...
function createTokenVisitor(visitors, type, isExit) {
  let v = createArrayVisitor(visitors, (visitor, /** @type {import('lightningcss/node/ast').TokenOrValue} */ item) => {
    let f;
    switch (item.type) {
      case 'token':
        f = visitor.Token;
