    ...
    return `
      <div data-chart-container="true" 
           ...
           class="chart-container h-full w-full relative min-h-[290px] 
                 mobile:min-h-[400px] laptop:min-h-0 font-archiv transition-all 
...
// Делегування подій на рівні документу
...
window.addEventListener('resize', () => {
  ...
  if (newIsLaptop !== isLaptop) {
    ...
    // Якщо перейшли на mobile, автоматично розгортаємо всі мінімізовані діаграми
    if (!isLaptop) {
